...
class MotionSimLayer:
    """given a real valued 3D MRI image, simulate random translations and rotations
        ...
        :param corrupt_pct_range (list of ints): range of percents  #这是什么
    ...
    def __init__(self, std_rotation_angle=3, std_translation=3, corrupt_pct_range=(0, 30),
                 freq_encoding_dim=(0, 1, 2), preserve_center_pct=0.07,
                 apply_mask=True, nufft=False, corruption_scheme='gaussian',
    ...
    def _simulate_random_trajectory(self):
        ...
        #pct_corrupt = 0.3
        corrupt_matrix_shape = [int(x * math.sqrt(pct_corrupt)) for x in self.phase_encoding_shape]  #为什么percentage要sqrt?
